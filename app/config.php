...
$w_config = [
    ...
    'security_userlastname_property' => 'lastname',		//nom de la colonne pour le "nom"
    'security_userfirstname_property' => 'firstname',		//nom de la colonne pour le "prenom"
    ...
    'security_role_property' => 'droits_id',				//nom de la colonne pour le "role"

    'security_login_route_name' => 'login',			//nom de la route affichant le formulaire de connexion

    // configuration globale
    'site_name'	=> 'W the Blog', 								// contiendra le nom du site
];
